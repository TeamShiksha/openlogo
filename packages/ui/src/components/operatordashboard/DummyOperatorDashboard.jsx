import styles from "./Operator.module.css";//mock css file //to be replaced with origin Operator.module.css file. 
function OperatorDashboard() {
  return (
    ...
    <div className={styles["operator-page-container"]} data-testid="testid-operator-dashboard">
