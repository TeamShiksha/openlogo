...
import { Eye, EyeClosed, Zap, CheckCircle2, Circle } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Form fields */}
        <div className={styles["signup-fields"]}>
      ...
      <div className={styles["signup-footer-login"]}>
        <p
          onClick={toggleForm}
          className={styles["signup-footer-login-clickable"]}
        >
          {SIGNUP.footerText}{" "}
          <span
            className={styles["signup-footer-login-link"]}
            role="button"
            tabIndex={0}
            onKeyDown={(event) => {
              if (event.key === "Enter" || event.key === " ") {
