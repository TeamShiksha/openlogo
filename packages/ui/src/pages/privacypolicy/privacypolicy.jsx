  ...
  return (
    <div className="privacy-policy" style={{ padding: '20px', lineHeight: '1.6' }}>
      ...
      <ul>
        ...
        <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Openlogo.</li>
        ...
        <li><strong>Website:</strong> Refers to Openlogo, accessible from <a href="https://Openlogo.fyi">Openlogo.fyi</a>.</li>
      ...
      <ul>
        ...
        <li>For other purposes such as data analysis and improving the Service.</li>
      </ul>
      ...
      <p>We may update Our Privacy Policy from time to time. Changes are effective when they are posted on this page.</p>

      <h2>Contact Us</h2>
      <p>If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul>
        <li>By visiting this page on our website: <a href="https://Openlogo.fyi/contact">https://Openlogo.fyi/contact</a></li>
      </ul>
    </div>
  );
};
