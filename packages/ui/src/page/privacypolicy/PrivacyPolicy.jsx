  ...
  return (
    <div className={`container ${styles["privacy-page-container"]}`}>
      ...
      <p className={styles.text}>
        ...
        features used, and your activity within our platform. If you contact us
        for support or inquiries, we may collect the content of those
        communications.
      </p>
      <p className={styles.text}>
      ...
      <p className={styles.text}>
        ...
        services. For more information on cookies and how to manage them, please
      ...
      <br />
      <h2 data-testid="t-and-c" id="t-and-c" className={styles.heading}>
      ...
      <p className={styles.text}>
        ...
        credentials, including your password, and for all activities that occur
        under your account.
      </p>
      <p className={styles.text}>
