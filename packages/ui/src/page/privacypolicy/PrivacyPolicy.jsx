  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>
        ...
        contract between us and our users. We&apos;ve provided a concise summary
        followed by the complete legal terms.
      </p>
      <br />
      ...
      <p className={styles.text}>
        Openlogo collects personal information such as your name, email address,
        and other details when you register for an account or use specific
        features on our platform. We also gather usage data about how you
        interact with our website and services, including pages viewed, features
        used, and your activity within our platform. If you contact us for
        support or inquiries, we may collect the content of those
        communications.
      </p>
      <p className={styles.text}>
        ...
        experience on Openlogo and improve our services based on your
        preferences.
      </p>
      <p className={styles.text}>
        ...
        help us provide a more personalized user experience. You can manage your
        cookie settings through your browser, but please note that disabling
        certain cookies may affect some features of the website and services.
        For more information on cookies and how to manage them, please visit our
        Cookie Policy.
      </p>
      <p className={styles.text}>
      ...
      <p className={styles.text}>
        ...
        information from a child under 13, please contact us immediately, and we
      ...
      <p className={styles.text}>
        ...
        updated accordingly. We encourage you to review this policy regularly to
      ...
      <p className={styles.text}>
        ...
        laws and regulations while using our services. You are responsible for
      ...
      <p className={styles.text}>
        Openlogo reserves the right to modify or discontinue services, in whole
        or in part, at any time without prior notice. We are not liable for any
        direct or indirect damages resulting from the use of our services,
        including but not limited to loss of data, loss of revenue, or business
        interruption.
      </p>
      <p className={styles.text}>
        Openlogo may, from time to time, offer promotional codes, discounts, or
        special offers that are subject to additional terms and conditions. We
        reserve the right to cancel or modify any offers at our discretion.
