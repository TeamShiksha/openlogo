...
<details>
  <summary><strong>API_REQUESTS</strong> – Lightweight records for tracking logo API requests over time</summary>
  <table>
    <thead>
      <tr><th>Field</th><th>Type</th><th>Description</th></tr>
    </thead>
    <tbody>
      <tr><td>user_id</td><td>ObjectId (ref: users)</td><td>User who made the API request (required)</td></tr>
